...
export function Step3Microcaps({
  ...
  const handleCopyClick = async (index: number, text: string) => {
    ...
    setTimeout(() => setCopiedIndex(null), 15000);
  };
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* COURSE BANNER */}
          <div className="w-full h-[60px] rounded-[12px] bg-[#D1EAFD] px-[12px] py-[14px] flex items-center gap-[20px]">
            <span className="h-[32px] min-w-[86px] rounded-[6px] bg-[#EEF7FF] text-[#2B506B] text-[18px] font-[600] leading-[24px] tracking-[-0.5px] flex items-center justify-center px-[6px] py-[4px]">
              {code}
            </span>

            <span className="h-[32px] flex items-center text-[18px] font-[500] uppercase leading-[16px] text-[#2B506B]">
              {name}
            </span>
          </div>

          {/* TOPIC BANNER */}
          <div className="w-full h-[52px] rounded-[12px] bg-[#D1EAFD] px-[12px] py-[14px] flex items-center gap-[20px] text-[18px] font-[500] uppercase leading-[16px] text-[#2B506B]">
            {selectedTopic}
          </div>
              ...
              {microcapsules.map((text, idx) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-[10px]">
                    ...
                    <span className="text-[14px] font-[500] leading-[16px] text-[#696969]">
                      Microcápsula #{idx + 1}
                    </span>
                  </div>
                  ...
                  <button
                    ...
                    className="absolute top-[10px] right-[10px] inline-flex items-center justify-center w-[24px] h-[24px] bg-white rounded-[6px] hover:scale-110 transition"
                  >
                    <Copy
                      className={`
                  ...
                  {/* TEXT */}
                  <p className="text-[14px] font-[400] leading-[20px] text-[#5A5C5E] text-justify pr-[10px]">
                    {text}
                  </p>
                </li>
              ))}
